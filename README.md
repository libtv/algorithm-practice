...
> **2** : 재귀적 알고리즘을 이용하여 부분 집합 생성 및 수열 생성 <br>
> **3** : 2진 검색 및 버블 정렬, 합병 정렬 <br>
> **4** : 동적 계획법 알고리즘 설계 기법을 이용하여 그리드 알고리즘, LIS 알고리즘, 해의 개수, 짐 싸기, 격자상의 경로 <br>
> **5** : 그래프 알고리즘을 이용하여 문제를 주어진 상황의 그래프로 표현하고 적절한 그래프 알고리즘으로 해결하는 방법에 대해 알아보는 챕터입니다. <br> <br>
